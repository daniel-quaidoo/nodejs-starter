...
export class ServiceDto {
    ...
    @ApiProperty({ example: '31dc513a-b801-444f-894d-41bcba1b42563', description: 'The unique identifier for the service' })
    @IsUUID()
    @IsNotEmpty()
    id: string;
    ...
    @ApiProperty({ example: 'land-docs', description: 'The alias or slug for the service' })
    @IsString()
    @IsNotEmpty()
    alias: string;
    ...
    @ApiProperty({ example: 'Service for documenting land ownership', description: 'A description of the service' })
    @IsString()
    @IsNotEmpty()
    description: string;
